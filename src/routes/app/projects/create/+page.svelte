...
<div class="container mx-auto pt-10 px-4 max-w-2xl">
    <a
        ...
        class="text-neutral-500 hover:underline mb-4 block"
        >&larr; Back to selection</a
    >

    <h1 class="text-4xl font-bold text-neutral-700 mb-8 uppercase">
        Create your {typeLabels[type] || "Project"}
    </h1>
    ...
    >
        <div>
            ...
            <input
                ...
                maxlength="30"
            />
            <p class="text-right text-xs text-neutral-400 mt-1">
                {title.length}/30
            </p>
        </div>
