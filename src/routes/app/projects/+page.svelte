...
<div class="container mx-auto pt-10">
    <div class="mt-3">
        ...
        {#if data.projects.length === 0}
            <p class="{mediumSize ? 'text-xl' : 'text-3xl'} text-neutral-600 mb-6">No projects found.</p>
            <a href="/app/projects/select" class="inline-block bg-blue-600 text-white px-6 py-3 rounded-lg font-bold hover:bg-blue-700 transition-colors">Create Your First Project</a>
        {:else}
            <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
                <!-- New Project Card -->
                <a href="/app/projects/select" class="block {mediumSize ? 'max-w-sm' : ''} group">
                    <div class="rounded-lg shadow-lg overflow-hidden h-full border-2 border-dashed border-neutral-300 hover:border-neutral-500 bg-neutral-50 flex flex-col items-center justify-center p-8 transition-colors">
                        <span class="text-5xl text-neutral-400 group-hover:text-neutral-600 mb-2">+</span>
                        <span class="font-bold text-neutral-500 group-hover:text-neutral-700">New Project</span>
                    </div>
                </a>
